...
else{return true;}});}});});$.each($(':submit',this),function(){if($(this).data('html5form')){return};$(this).data('html5form',true);$(this).bind('click',function(ev){var emptyInput=null;var emailError=null;var input=$(':input:not(:button, :submit, :radio, :checkbox, select)',form);required.length=0;$(input).each(function(i){if(this.getAttribute('required')!=null){required[i]=$(this);}});
